...
class Menu():
    def __init__(self, level, camera, player):
        self.run = True
        ...
        self.camera = camera
        self.player = player
        self.player.rect = pygame.Rect(WIDTH / 4, 840, BLOCK_SIZE, BLOCK_SIZE * 2)
